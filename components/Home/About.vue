<template>
<div class="gd_wrapabout py-6">
  <div class="container">
      <section class="gd_sectionheader has-text-centered pb-6">
      <h3 class="is-size-1"><span class="gd_headingwhite">About</span> <span class="gd_headingred">Us</span></h3>
      </section>
      <section class="columns has-text-white pb-6 gd_aboutdesc">
